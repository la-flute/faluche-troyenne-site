      ...
      <React.Fragment>
        ...
        <Switch>
          ...
          {this.state.render && user && (
            <Route path={baseUrl + 'user/caution'} exact component={Caution} />
          )}
          ...
          {this.state.render && user && user.validated && (
            <Route
              path={baseUrl + 'user/bedrooms'}
              exact
              component={Bedrooms}
            />
          )}
          ...
          {this.state.render && user && user.image && user.validated && (
            <Route
              path={baseUrl + 'tinder/view'}
              exact
