...
class Home extends React.Component {
    ...
    componentWillMount() {
        ...
        document.addEventListener('scroll', this.scrollCapture, {
            passive: true,
        })
    }
    ...
    scrollCapture() {
        ...
        document.body.className =
            scrollTop >= document.body.scrollHeight - bottom
                ? 'a-social-fixed'
                : ''
    }
                    ...
                    <div className='a-home__content'>
                        ...
                        <div className='palier'>
                            <span className='palier-title'>
                                <strong className='palier-title-1'>
                                    Premier palier
                                </strong>{' '}
                                (jusqu'au 02/04/2019)
                            </span>
                            ...
                            <br />
                            <span className='palier-title'>
                                <strong className='palier-title-2'>
                                    Deuxième palier
                                </strong>{' '}
                                (du 03/04/2019 au 17/04/2019)
                            </span>
                            <span>
                                Week-End avec alcool{' '}
                                <strong className='palier-title-2'>
                            ...
                            <br />
                            <span className='palier-title'>
                                <strong className='palier-title-3'>
                                    Troyesieme palier
                                </strong>{' '}
                                (du 18/04/2019 au 03/05/2019)
                            </span>
                            <span>
                                Week-End avec alcool{' '}
                                <strong className='palier-title-3'>
                            ...
                            <br />
                            <span>
                                (<span className='Deathstar'>+</span>7€ si
                                couchage en dur)
                            </span>
                        </div>
                        ...
                        <div className='bk'>
                            ...
                            <span>
                                la voix des pois - centre commercial l'escapade
                            </span>
                        ...
                        <div className='remboursement'>
                            <span>
                                ...
                                <strong className='Deathstar'>
                                    laflute.troyes@gmail.com
                                </strong>{' '}
                                avant le 22/04/2019 (deadline pour se faire
                                rembourser, aucun remboursement accepté après
                                cette date)
                            </span>
                        </div>
                    </div>
...
const mapDispatchToProps = dispatch => ({
    goToTroll: () =>
        dispatch(
            push('/mectesstupidtucroyaisvraimentquonallaitouvrirmaintenant')
        ),
