...
const Scroll = () => (<div className='a-swag-container'>
      <section className='star-wars'>
        <div className='crawl'>
          ...
          <p>
            Luke SkyPoutré, entraîné par Maître Coma, doit savoir user de son
            foie afin de sauver son ami.
          </p>
          <p>
          ...
          <p>
            ...
            les Stormpoutreurs, connus pour être la force de pliage de
            l'Empire...
          </p>
