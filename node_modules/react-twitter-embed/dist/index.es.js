  ...
  createClass(TwitterTimelineEmbed, [{
    ...
    value: function componentDidMount() {
      ...
      script.ready('twitter-embed', function () {
        ...
        var options = Object.assign({}, _this2.props.options);
...
var script$1 = require('scriptjs');

script$1('https://platform.twitter.com/widgets.js', 'twitter-embed');
...
var TwitterShareButton = function (_Component) {
  ...
  createClass(TwitterShareButton, [{
    ...
    value: function componentDidMount() {
      ...
      script$1.ready('twitter-embed', function () {
        if (!window.twttr) {
          console.error('Failure to load window.twttr, aborting load.');
          return;
        }
...
var script$2 = require('scriptjs');

script$2('https://platform.twitter.com/widgets.js', 'twitter-embed');
...
var TwitterFollowButton = function (_Component) {
  ...
  createClass(TwitterFollowButton, [{
    ...
    value: function componentDidMount() {
      ...
      script$2.ready('twitter-embed', function () {
        if (!window.twttr) {
          console.error('Failure to load window.twttr, aborting load.');
          return;
        }
...
var script$3 = require('scriptjs');

script$3('https://platform.twitter.com/widgets.js', 'twitter-embed');
...
var TwitterHashtagButton = function (_Component) {
  ...
  createClass(TwitterHashtagButton, [{
    ...
    value: function componentDidMount() {
      ...
      script$3.ready('twitter-embed', function () {
        if (!window.twttr) {
          console.error('Failure to load window.twttr, aborting load.');
          return;
        }
...
var script$4 = require('scriptjs');

script$4('https://platform.twitter.com/widgets.js', 'twitter-embed');
...
var TwitterMentionButton = function (_Component) {
  ...
  createClass(TwitterMentionButton, [{
    ...
    value: function componentDidMount() {
      ...
      script$4.ready('twitter-embed', function () {
        if (!window.twttr) {
          console.error('Failure to load window.twttr, aborting load.');
          return;
        }
...
var script$5 = require('scriptjs');

script$5('https://platform.twitter.com/widgets.js', 'twitter-embed');
...
var TwitterTweetEmbed = function (_Component) {
  ...
  createClass(TwitterTweetEmbed, [{
    ...
    value: function componentDidMount() {
      ...
      script$5.ready('twitter-embed', function () {
        if (!window.twttr) {
          console.error('Failure to load window.twttr, aborting load.');
          return;
        }
...
var script$6 = require('scriptjs');

script$6('https://platform.twitter.com/widgets.js', 'twitter-embed');
...
var TwitterMomentShare = function (_Component) {
  ...
  createClass(TwitterMomentShare, [{
    ...
    value: function componentDidMount() {
      ...
      script$6.ready('twitter-embed', function () {
        if (!window.twttr) {
          console.error('Failure to load window.twttr, aborting load.');
          return;
        }
...
var script$7 = require('scriptjs');

script$7('https://platform.twitter.com/widgets.js', 'twitter-embed');
...
var TwitterDMButton = function (_Component) {
  ...
  createClass(TwitterDMButton, [{
    ...
    value: function componentDidMount() {
      ...
      script$7.ready('twitter-embed', function () {
        if (!window.twttr) {
          console.error('Failure to load window.twttr, aborting load.');
          return;
        }
...
var script$8 = require('scriptjs');

script$8('https://platform.twitter.com/widgets.js', 'twitter-embed');
...
var TwitterVideoEmbed = function (_Component) {
  ...
  createClass(TwitterVideoEmbed, [{
    ...
    value: function componentDidMount() {
      ...
      script$8.ready('twitter-embed', function () {
        if (!window.twttr) {
          console.error('Failure to load window.twttr, aborting load.');
          return;
        }
...
var script$9 = require('scriptjs');

script$9('https://platform.twitter.com/widgets.js', 'twitter-embed');
...
var TwitterOnAirButton = function (_Component) {
  ...
  createClass(TwitterOnAirButton, [{
    ...
    value: function componentDidMount() {
      ...
      script$9.ready('twitter-embed', function () {
        if (!window.twttr) {
          console.error('Failure to load window.twttr, aborting load.');
          return;
        }
